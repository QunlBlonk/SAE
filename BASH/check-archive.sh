...
if [ $nombre_ligne_archives -eq 1 ]; then
...
#demande si on veut effacer et recréer temp pour le rmeplir ou non des nouvelles informations
if [ ! -e "./temp" ]; then
        mkdir temp
        else
...
combien_fichier=`wc -l temp/data`
